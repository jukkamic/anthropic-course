...
class CliChat(Chat):
    def __init__(
        self,
        customer_client: MCPClient,
        clients: dict[str, MCPClient],
        claude_service: Claude,
    ):
        super().__init__(clients=clients, claude_service=claude_service)

        self.customer_client: MCPClient = customer_client
    ...
    async def get_prompt(
        ...
        return await self.customer_client.get_prompt(command, {"doc_id": doc_id})
    ...
    async def _process_command(self, query: str) -> bool:
        ...
        messages = await self.customer_client.get_prompt(
